...
5. Specify and implement Wave 2 Core roots only after explicit wave-scoped authorization.
6. Apply the RI-2 physical gate before any NutritionTarget backfill.
7. Validate controlled cutover, rollback, observability, and safety invariants.
8. Deprecate compatibility readers only after parity, telemetry, archive fallback, retention, and owner acceptance.
