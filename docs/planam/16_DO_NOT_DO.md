...
- Do not treat Account, Person, and Membership as one entity.
- Do not require an Account for a dependent.
- Do not copy restricted `birth_date` broadly.
- Do not use UI visibility as authorization.
- Do not convert missing or unknown to zero or safe.
