...
const variantClasses: Record<Button2026Variant, string> = {
  ...
  secondary:
    "border border-sage-200 bg-pa-surface text-sage-700 hover:bg-sage-50 active:scale-[0.99] disabled:opacity-40 dark:border-pa-border dark:bg-pa-elevated dark:text-sage-300 dark:hover:bg-white/5",
  ghost:
    "bg-transparent text-sage-700 hover:bg-sage-50 active:scale-[0.99] disabled:opacity-40 dark:text-sage-300 dark:hover:bg-white/5",
  danger:
