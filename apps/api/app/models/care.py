...
class CareSettings(Base):
    ...
    shopping_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    pantry_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    ...
    care_level: Mapped[str] = mapped_column(String(16), default="off")
...
class CareNotification(Base):
    ...
    semantic_key: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
