...
class UserNotificationSettings(Base):
    ...
    cook_lunch_time: Mapped[str] = mapped_column(String(5), default="13:00")
    cook_dinner_time: Mapped[str] = mapped_column(String(5), default="18:00")
    ...
    last_breakfast_sent_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    last_lunch_sent_date: Mapped[date | None] = mapped_column(Date, nullable=True)
    last_dinner_sent_date: Mapped[date | None] = mapped_column(Date, nullable=True)
