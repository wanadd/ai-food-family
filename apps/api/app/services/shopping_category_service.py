...
SYSTEM_CATEGORIES: list[tuple[str, str, str | None, bool]] = [
    ...
    ("алкоголь", "Алкоголь", "🍷", True),
    ("хлеб", "Хлеб", "🍞", True),
    ("заморозка", "Заморозка", "🧊", True),
    ("другое_продуктовое", "Другое продуктовое", "🥫", True),
    ("дом_и_химия", "Дом и химия", "🧴", False),
    ("хозтовары", "Хозтовары", "🧹", False),
    ("ребенку", "Ребёнку", "🧸", False),
    ("подарки", "Подарки", "🎁", False),
    ("одежда_и_обувь", "Одежда и обувь", "👕", False),
    ("аптека", "Аптека", "💊", False),
    ("ремонт", "Ремонт", "🔧", False),
