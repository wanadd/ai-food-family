...
PLAN_MODE_PROMPT_HINTS = {
    "quick_simple": (
        "Сделай акцент на быстром и простом меню (вариант quick): "
        "короткая готовка, простые блюда."
    ),
    "economy": (
        "Сделай акцент на экономном меню (вариант economy): "
        "бюджетные продукты."
    ),
    "healthy": (
    ...
    "sport": (
        "Учти спортивный режим: достаточно белка и энергии."
    ),
    "family": (
        "Учти семейный формат: блюда, удобные для нескольких человек."
    ),
    "use_pantry": (
        "Максимально используй остатки и запасы, минимизируй новые покупки."
    ),
}
